...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _IApponintmentsRepository.default === "undefined" ? Object : _IApponintmentsRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class ListProviderMonthAvailabilityService {
  ...
  async execute({
    ...
    const availability = eachDayArray.map(day => {
      ...
      return {
        day,
        available: (0, _dateFns.isAfter)(compareDate, new Date()) && appontmentsInDay.length < 10
      };
    });
    return availability;
  }
