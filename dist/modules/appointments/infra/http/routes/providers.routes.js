...
var _ensureAuthenticate = _interopRequireDefault(require("@modules/users/infra/http/middlewares/ensureAuthenticate"));
...
providersRouter.use(_ensureAuthenticate.default);
