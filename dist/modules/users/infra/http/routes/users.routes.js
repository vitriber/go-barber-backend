...
var _ensureAuthenticate = _interopRequireDefault(require("../middlewares/ensureAuthenticate"));
...
usersRouter.patch('/avatar', _ensureAuthenticate.default, upload.single('avatar'), userAvatarController.update);
